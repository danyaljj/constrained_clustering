...
% two steps (suppose we train on dat0, test on dat1):
%	mu0 = kvmfs(dat0,kc,'maxi',0,'ipart',classid);
%	[mu1,ci] = kvmfs(dat1,kc,'maxi',1,'imeans',mu0);
% and then compare the resulting ci with the initial partition vector classid
% to get the number of misclassified documents.
%
% See also: MIXVMFS, SKVMFS, KMNS, UNITNORM
